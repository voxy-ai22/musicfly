...
import { ArrowLeft, Globe, Youtube, Twitter, Instagram, Coffee, Download, BadgeCheck } from "lucide-react";
      ...
      <main className="p-6">
        ...
        <div className="flex flex-col items-center mt-12 mb-8">
          ...
          <div className="flex items-center gap-2 mb-2">
             ...
             <BadgeCheck className="size-5 text-white fill-blue-500" />
          </div>
        ...
        <div className="grid grid-cols-4 gap-3 mb-6">
           {[
             { icon: Globe, label: "Website", href: "https://nexadev.my.id" },
             { icon: Youtube, label: "Saluran", href: "https://youtube.com" },
             ...
             <a
               ...
               className="bg-[#1f1f1f] p-4 rounded-xl flex flex-col items-center gap-2 hover:bg-white/5 active:bg-white/10 transition-colors"
             >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-full bg-[#1f1f1f] p-4 rounded-xl flex items-center gap-4 mb-6 hover:bg-white/5 active:bg-white/10 transition-colors"
        >
        ...
        <button
          type="button"
          onClick={() => window.open("/musicply.apk", "_blank")}
          className="w-full bg-[#1f1f1f] p-5 rounded-xl flex items-center justify-center gap-3 font-bold hover:bg-white/5 active:bg-white/10 transition-colors border border-white/5"
        >
